...
type
  ...
  public
    ...
    procedure GanhouMedalhaOuro(codCidade: Integer);
    procedure GanhouMedalhaPrata(codCidade: Integer);
    procedure GanhouMedalhaBronze(codCidade: Integer);
  end;
...
procedure Tdm.GanhouMedalhaBronze(codCidade: Integer);
begin
  dm.query.Close;
  dm.query.sql.Text := 'update cidades set medalhas_bronze = medalhas_bronze + 1 where codigo = ' + IntToStr(codCidade);
  dm.query.ExecSQL;
end;

procedure Tdm.GanhouMedalhaOuro(codCidade: Integer);
begin
  dm.query.Close;
  dm.query.sql.Text := 'update cidades set medalhas_ouro = medalhas_ouro + 1 where codigo = ' + IntToStr(codCidade);
  dm.query.ExecSQL;
end;

procedure Tdm.GanhouMedalhaPrata(codCidade: Integer);
begin
  dm.query.Close;
  dm.query.sql.Text := 'update cidades set medalhas_prata = medalhas_prata + 1 where codigo = ' + IntToStr(codCidade);
  dm.query.ExecSQL;
end;
